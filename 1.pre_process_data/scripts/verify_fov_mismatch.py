...
timelapse_fov1 = tifffile.imread(
    pathlib.Path(f"{raw_data_timelapse_path}/C-02_F0001_T0013_Z0001_C01.tif").resolve(
        strict=True
    )
)
timelapse_fov2 = tifffile.imread(
    pathlib.Path(f"{raw_data_timelapse_path}/C-02_F0002_T0013_Z0001_C01.tif").resolve(
        strict=True
    )
)
timelapse_fov3 = tifffile.imread(
    pathlib.Path(f"{raw_data_timelapse_path}/C-02_F0003_T0013_Z0001_C01.tif").resolve(
        strict=True
    )
)
timelapse_fov4 = tifffile.imread(
    pathlib.Path(f"{raw_data_timelapse_path}/C-02_F0004_T0013_Z0001_C01.tif").resolve(
        strict=True
    )
)
terminal_fov1 = tifffile.imread(
    pathlib.Path(f"{raw_data_terminal_path}/C-02_F0001_T0001_Z0001_C01.tif").resolve(
        strict=True
    )
)
terminal_fov2 = tifffile.imread(
    pathlib.Path(f"{raw_data_terminal_path}/C-02_F0002_T0001_Z0001_C01.tif").resolve(
        strict=True
    )
)
terminal_fov3 = tifffile.imread(
    pathlib.Path(f"{raw_data_terminal_path}/C-02_F0003_T0001_Z0001_C01.tif").resolve(
        strict=True
    )
)
terminal_fov4 = tifffile.imread(
    pathlib.Path(f"{raw_data_terminal_path}/C-02_F0004_T0001_Z0001_C01.tif").resolve(
        strict=True
    )
)
terminal_fov5 = tifffile.imread(
    pathlib.Path(f"{raw_data_terminal_path}/C-02_F0005_T0001_Z0001_C01.tif").resolve(
        strict=True
    )
)
terminal_fov6 = tifffile.imread(
    pathlib.Path(f"{raw_data_terminal_path}/C-02_F0006_T0001_Z0001_C01.tif").resolve(
        strict=True
    )
)
